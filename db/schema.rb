...
ActiveRecord::Schema.define(version: 2020_12_25_032130) do
  ...
  create_table "shipping_informations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["purchases_id"], name: "index_shipping_informations_on_purchases_id"
  end
  ...
  add_foreign_key "shipping_informations", "purchases", column: "purchases_id"
end
